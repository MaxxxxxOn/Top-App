    ...
    return (
        <div className={className}{...props} ref={ref}>
            <Card className={styles.product}>
                ...
                <div className={styles.tag}>{product.categories.map(c => <Tag key={c} className={styles.categories}
                ...
                <div
                    className={styles.rateTitle}><a href={"#ref"}
                                                    onClick={scrollToReview}>{product.reviewCount} {devlOfNum(product.reviewCount, ['отзыв', 'отзыва', 'отзывов'])}</a>
                </div>
